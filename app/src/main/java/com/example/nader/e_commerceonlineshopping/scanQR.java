...
public class scanQR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button confQR = (Button) findViewById(R.id.button2);
        confQR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (((TextView) findViewById(R.id.textView6)).getText().toString().equals("Place the Camera to scan QR code")) {
                    Toast.makeText(getApplicationContext(), "Invalid QR code", Toast.LENGTH_LONG).show();
                } else {
                    Intent i = new Intent(scanQR.this, SearchActivity.class);
                    i.putExtra("QRhelper", ((TextView) findViewById(R.id.textView6)).getText().toString());
